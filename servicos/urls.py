...
urlpatterns = [
    ...
    path("exportar/", views.exportar_servicos, name="exportar_servicos"),
    ...
    path("recebedores/exportar/", views.exportar_recebedores, name="exportar_recebedores"),
    # URLs para Clientes/Empresas
    path("clientes-empresas/exportar/", views.exportar_clientes_empresas, name="exportar_clientes_empresas"),
